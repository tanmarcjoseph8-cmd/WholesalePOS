...
- `apk/WholesalePOS-Offline-0.3.1-release.apk`: signed APK for direct tablet installation
- `apk/WholesalePOS-Offline-0.3.1-debug.apk`: development APK
- `apk/WholesalePOS-Offline-0.3.1-release.aab`: signed Android App Bundle
