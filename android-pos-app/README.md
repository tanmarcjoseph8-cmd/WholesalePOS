...
- `apk/WholesalePOS-Offline-0.4.0-release.apk`: signed APK for direct tablet installation
- `apk/WholesalePOS-Offline-0.4.0-debug.apk`: development APK
- `apk/WholesalePOS-Offline-0.4.0-release.aab`: signed Android App Bundle
