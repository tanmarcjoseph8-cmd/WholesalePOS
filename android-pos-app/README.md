...
- `apk/WholesalePOS-Offline-0.3.2-release.apk`: signed APK for direct tablet installation
- `apk/WholesalePOS-Offline-0.3.2-debug.apk`: development APK
- `apk/WholesalePOS-Offline-0.3.2-release.aab`: signed Android App Bundle
