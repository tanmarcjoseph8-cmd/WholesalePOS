...
Suki Sync 0.7.0 supports Fire OS 7, which uses Android API 28.
...
4. Transfer `Suki-Sync-0.7.0-release.apk` to the tablet.
5. Open the APK and choose **Install**.
6. Open Suki Sync, activate it, and complete owner setup.
...
Install version 0.7.0 over the existing WholesalePOS Offline installation. Do not
...
Application Notifications > Suki Sync** when that menu is available.
