...
Version 0.6.0 supports Fire OS 7, which uses Android API 28.
...
4. Transfer `WholesalePOS-Offline-0.6.0-release.apk` to the tablet.
...
Install version 0.6.0 over the existing WholesalePOS Offline installation. Do not
