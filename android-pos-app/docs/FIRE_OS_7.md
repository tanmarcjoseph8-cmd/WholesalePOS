...
Version 0.2.0 supports Fire OS 7, which uses Android API 28.
...
4. Transfer `WholesalePOS-Offline-0.2.0-release.apk` to the tablet.
...
Install version 0.2.0 over the existing WholesalePOS Offline installation. Do not
