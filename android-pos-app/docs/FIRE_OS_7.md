...
Version 0.3.1 supports Fire OS 7, which uses Android API 28.
...
4. Transfer `WholesalePOS-Offline-0.3.1-release.apk` to the tablet.
...
Install version 0.3.1 over the existing WholesalePOS Offline installation. Do not
