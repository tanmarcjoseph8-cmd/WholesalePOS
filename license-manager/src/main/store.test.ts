...
const input = { customerName: "Ana Santos", businessName: "Ana Store", contactNumber: "", email: "", customerNotes: "Paid in Full", deviceId: "WPOS-AAAA-BBBB", productId: "WHOLESALE_POS_ANDROID", appVersion: "0.6.0", licenseNotes: "Lifetime License" };
